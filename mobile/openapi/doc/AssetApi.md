...
# **updateStack**
> updateStack(updateAssetStackDto)
...
final api_instance = AssetApi();
final updateAssetStackDto = UpdateAssetStackDto(); // UpdateAssetStackDto | 

try {
    api_instance.updateStack(updateAssetStackDto);
} catch (e) {
    print('Exception when calling AssetApi->updateStack: $e\n');
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **updateAssetStackDto** | [**UpdateAssetStackDto**](UpdateAssetStackDto.md)|  | 
